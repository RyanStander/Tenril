...
public class UtilityMovement : MonoBehaviour
{
    ...
    [Range(-1, 1)] public float targetWeight = 2;
    ...
    [Range(0, 1)] public float targetDistanceSensitivity = 2;
    ...
    private UtilityRay CalculateUtilityRay(int rayNumber)
    {
        ...
        if (Physics.Raycast(baseRay, out RaycastHit hit, utilityRayRange))
        {
            ...
            {
                utility = objectDistanceImpact * targetDistanceSensitivity;
            }
            else
            {
                utility = objectDistanceImpact * obstacleDistanceSensitivity;
            }
        }

        //TODO: Implement preference towards target
    ...
    [Range(0, 360)] private float currentAngle = 0;
