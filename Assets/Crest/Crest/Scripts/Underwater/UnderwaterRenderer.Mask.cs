...
namespace Crest
{
    ...
    public partial class UnderwaterRenderer
    {
        ...
        internal static void DisableOceanMaskKeywords()
        {
            ...
            OceanRenderer.Instance.OceanMaterial.EnableKeyword("CREST_WATER_VOLUME_NONE");
            OceanRenderer.Instance.OceanMaterial.DisableKeyword(k_KeywordVolume2D);
            OceanRenderer.Instance.OceanMaterial.DisableKeyword(k_KeywordVolumeHasBackFace);
        }
